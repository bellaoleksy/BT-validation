...
green_nonzero2 <- ggplot(data_chlb_total_nonzeros, aes(y=sqrt_BT_green,x=sqrt_UPLC_chlb)) +
  ...
  scale_y_continuous(name = expression("SR"~green["BT"]~(mu*g/cm^2))) +
  scale_x_continuous(name = expression("SR"~chlb["UPLC"]~(mu*g/cm^2)))
...
green_nonzero1 <- ggplot(data_chlb_total_nonzeros, aes(y=sqrt_BT_green_perc,x=sqrt_UPLC_chlb_perc)) +
  geom_point(size=1) +
   ...
   stat_poly_eq(formula = green_nonzero_eqn_1, 
                ...
                parse = TRUE) +
     ggtitle("Green algae (non-zeros)")+
  scale_y_continuous(labels= scales::percent, name = expression("SR"~green["BT"]~"")) +
  scale_x_continuous(name = expression("SR"~chlb["UPLC"]~""))
...
cyano1 <- ggplot(data_myxo_full, aes(y=sqrt_BT_cyano_perc,x=sqrt_UPLC_myxo_perc)) +
  ...
  expand_limits(y=1.0,x=0.4)+
  scale_y_continuous(labels= scales::percent, breaks=seq(0,1.0,0.25), name = expression("sqrt"~cyano["BT"]~"")) +
  scale_x_continuous(breaks=c(0,0.1,0.2,0.3,0.4), labels=c("0%","10%", "20%", "30%","40%"), name = expression("sqrt"~myxo["UPLC"]~""))
...
diatoms1 <- ggplot(data_fuco, aes(y=log_BT_diat_perc,x=log_UPLC_diat_perc)) +
  ...
  scale_y_continuous(breaks=c(0,0.1,0.2,0.3), labels=c("0%","10%", "20%", "30%"), name = expression(log~diatoms["BT"]~"")) +
  scale_x_continuous(breaks=c(0,0.1,0.2,0.3), labels=c("0%","10%", "20%", "30%"), name = expression(log~fuco["UPLC"]~""))
...
diatoms2 <- ggplot(data_fuco, aes(y=log_BT_diat,x=log_UPLC_diat)) +
  ...
  scale_y_continuous(breaks=seq(0, 0.80, 0.20),name = expression(log~diatoms["BT"]~(mu*g/cm^2))) +
  scale_x_continuous(breaks=seq(0, 0.2, 0.05), name = expression(log~fuco["UPLC"]~(mu*g/cm^2)))
...
# ggsave("figures/figure2-A_allpigments.tiff", width=12, height=16,units="in")
...
all_stacked <- ggarrange(chla_panel,
          ...
          nrow=2,
          widths = c(4,4), heights = c(0.3,1.0))
# ggsave("figures/figure2-B_allpigments.tiff", width=8, height=16,units="in")
...
# ggsave("figures/figure3_green_breakpoints.tiff", width=12, height=8,units="in")
...
green_nonzeros <-
          ...
          labels = c("A", "B"),
          widths = c(4,4), heights = c(0.3,0.3))
# ggsave("figures/figX_green_nonzeros.png", width=12, height=8,units="in")
...
green_allfigs <-
          ...
          labels = c("A", "B", "C","D"),
          widths = c(4,4), heights = c(0.3,0.3))
# ggsave("figures/figX_green_allfigs.png", width=12, height=12,units="in")
...
greens1_covariates <- ggplot(data_chlb_total,
  aes(y=sqrt_BT_green_perc,x=sqrt_UPLC_chlb_perc,color=investigator, fill=investigator)) +
  geom_point(size=3) +
  geom_smooth(method = "lm", se=FALSE) +
  ggtitle("Greens")+
  expand_limits(y=1.0,x=1.0)+
  scale_y_continuous(breaks=seq(0,1.0,0.1), name = expression(sqrt~greens["BT"]~"%")) +
  scale_x_continuous(name = expression(sqrt~chlb["UPLC"]~"%"))
greens1_covariates
```
...
greens2_covariates <- ggplot(data_chlb_total,
 aes(y=sqrt_BT_green,x=sqrt_UPLC_chlb, color=investigator, fill=investigator)) +
 geom_point(size=3) +
 geom_smooth(method = "lm", se=FALSE) +
 ggtitle("Greens")+
 expand_limits(y=0.8,x=0.2)+
 scale_y_continuous(name = expression(sqrt~greens["BT"]~(mu*g/cm^2))) +
...
Relative abundances
```{r, echo=FALSE}
diatoms1_covariates <- ggplot(data_fuco, aes(y=log_BT_diat_perc,x=log_UPLC_diat_perc, color=investigator, fill=investigator)) +
  geom_point(size=3) +
   geom_smooth(method = "lm", se=FALSE) +
  ggtitle("Diatoms")+
  expand_limits(y=0.3,x=0.3)+
  scale_y_continuous(breaks=seq(0,0.3,0.1), name = expression(log~diatoms["BT"]~"%")) +
  scale_x_continuous(name = expression(log~fuco["UPLC"]~"%"))
diatoms1_covariates
```
...
Pigment concentrations
```{r, echo=FALSE}
diatoms2_covariates <- ggplot(data_fuco, aes(y=log_BT_diat,x=log_UPLC_diat, color=investigator, fill=investigator)) +
  geom_point(size=3) +
     geom_smooth(method = "lm", se=FALSE) +
  ggtitle("Diatoms")+
    expand_limits(y=0.8,x=0.2)+
  scale_y_continuous(name = expression(log~diatoms["BT"]~(mu*g/cm^2))) +
  scale_x_continuous(name = expression(log~fuco["UPLC"]~(mu*g/cm^2)))
diatoms2_covariates
```
...
Relative abundances
```{r, echo=FALSE}
cyano1_covariates <- ggplot(data_myxo_full, aes(y=sqrt_BT_cyano_perc,x=sqrt_UPLC_myxo_perc, color=investigator, fill=investigator)) +
  geom_point(size=3) +
   geom_smooth(method = "lm", se=FALSE) +
  ggtitle("Cyano")+
  expand_limits(y=1.0,x=1.0)+
  scale_y_continuous(breaks=seq(0,1.0,0.1), name = expression(sqrt~cyano["BT"]~"%")) +
  scale_x_continuous(name = expression(sqrt~myxo["UPLC"]~"%"))
cyano1_covariates
```
...
Pigment concentrations
```{r, echo=FALSE}
cyano2_covariates <- ggplot(data_myxo_full, aes(y=sqrt_BT_cyano,x=sqrt_UPLC_myxo, color=investigator, fill=investigator)) +
  geom_point(size=3) +
     geom_smooth(method = "lm", se=FALSE) +
  ggtitle("Cyano")+
    expand_limits(y=0.8,x=0.2)+
...
chla_investigator <- ggplot(data_chla_total, aes(y=log_BT_chla,x=log_UPLC_chla, color=investigator, fill=investigator)) +
  geom_point(size=3) +
   geom_smooth(method = "lm", se=FALSE) +
  ggtitle(expression(paste("Total chlorophyll ", italic("a"))))+
